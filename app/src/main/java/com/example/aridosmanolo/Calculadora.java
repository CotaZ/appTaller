...
public class Calculadora extends AppCompatActivity {
    ...
    private Button btn_Calcular, Volver,Pedido,Mapa,Calculadora,Menu, btn_MenArena,btn_MasArena,btn_MenGravilla,btn_MasGravilla,btn_MenRipio,btn_MasRipio,btn_MenMaicillo,btn_MasMaicillo,btn_MenBolones,btn_MasBolones,btn_MenCemento,btn_MasCemento,btn_MenBol9,btn_MasBol9,btn_MenBol14,btn_MasBol14,btn_MenBol19,btn_MasBol19;
    private TextView text_Arena;
    private TextView text_Gravilla;
    private TextView text_Ripio;
    private TextView text_Maicillo;
    private TextView text_Bolones;
    private TextView text_Cemento;
    private TextView text_Bol9;
    private TextView text_Bol14;
    private TextView text_Bol19;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_MenBol9 = findViewById(R.id.btn_MenBol9);
        btn_MasBol9 = findViewById(R.id.btn_MasBol9);
        btn_MenBol14 = findViewById(R.id.btn_MenBol14);
        btn_MasBol14 = findViewById(R.id.btn_MasBol14);
        btn_MenBol19 = findViewById(R.id.btn_MenBol19);
        btn_MasBol19 = findViewById(R.id.btn_MasBol19);
        ...
        btn_MasBol9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol9.getText().toString();
                int suma = Integer.parseInt(x);
                suma = suma+ 1;
                x = String.valueOf(suma);
                text_Bol9.setText(x);
        ...
        btn_MenBol9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol9.getText().toString();
                int resta = Integer.parseInt(x);
        ...
        btn_MasBol14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol14.getText().toString();
                int suma = Integer.parseInt(x);
                suma = suma+ 1;
                x = String.valueOf(suma);
                text_Bol14.setText(x);
            }
        });
        btn_MenBol14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol14.getText().toString();
                int resta = Integer.parseInt(x);
        ...
        btn_MasBol19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol19.getText().toString();
                int suma = Integer.parseInt(x);
                suma = suma+ 1;
                x = String.valueOf(suma);
                text_Bol19.setText(x);
            }
        });
        btn_MenBol19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String x = text_Bol19.getText().toString();
                int resta = Integer.parseInt(x);
